...
```shell
java -jar mybatis-plus-code-generator-3.5.2.3.jar
```
...
# 启动服务
docker run -d -p 8899:8899 --name code-generator -v ~/temp:/temp fengwenyi/mybatis-plus-code-generator:3.5.2.3
